          ...
          <div className="text-center mb-20">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <span className="block text-[#5B8C3E] mt-1 bg-gradient-to-r from-[#5B8C3E] to-[#7BAD50] bg-clip-text text-transparent">
                  Health Revolution
                </span>
              </motion.h2>
          ...
          {/* Enhanced paper-like container with depth and shadows */}
            ...
            <div className="p-8 sm:p-12 md:p-16 lg:p-20">
              {/* Premium quote highlight with icon and animations */}
                  ...
                  whileHover={{ x: 5 }}
                >
                {/* Fixed quote icon with appropriate SVG */}
                <div className="absolute -top-5 -left-3 bg-white rounded-full p-2.5 shadow-lg">
                  ...
                  >
                    <path d="M9.6,5.58C7.58,6.5,6.07,7.58,5.08,8.82C4.09,10.06,3.6,11.41,3.6,12.86c0,2.19,0.7,3.91,2.11,5.16 C7.12,19.26,8.93,19.89,11.14,19.89c0.59,0,1.07-0.22,1.45-0.65c0.38-0.43,0.58-0.96,0.58-1.59c0-0.59-0.19-1.08-0.57-1.47 c-0.38-0.38-0.82-0.58-1.34-0.58c-1.52,0-2.28-0.68-2.28-2.05c0-0.67,0.26-1.26,0.79-1.77c0.52-0.51,1.12-0.76,1.81-0.76 c1.01,0,1.89,0.44,2.66,1.3c0.77,0.86,1.15,1.89,1.15,3.09c0,1.38-0.44,2.66-1.32,3.84c-0.88,1.19-2.05,2.08-3.5,2.68 c-1.45,0.6-2.99,0.9-4.61,0.9c-1.6,0-3.08-0.28-4.42-0.85s-2.49-1.36-3.42-2.37C7.03,19.37,6.45,19,5.95,18.5 c-0.51-0.5-0.76-1.12-0.76-1.85c0-0.12,0.01-0.23,0.03-0.33c0.21,0.27,0.49,0.47,0.86,0.61c0.37,0.14,0.77,0.21,1.22,0.21 c0.76,0,1.42-0.25,1.97-0.75c0.55-0.5,0.83-1.11,0.83-1.83c0-0.69-0.23-1.27-0.69-1.74C8.95,12.35,8.34,12.12,7.6,12.12 c-1.26,0-2.34,0.72-3.24,2.16c-0.41-1.31-0.62-2.35-0.62-3.14c0-0.65,0.19-1.27,0.58-1.86c0.39-0.59,0.93-1.06,1.62-1.42 c0.69-0.36,1.56-0.7,2.61-1.02c1.05-0.32,2.26-0.61,3.62-0.86L9.6,5.58z M22.04,5.58c-2.02,0.92-3.53,2-4.51,3.24 c-0.99,1.24-1.48,2.59-1.48,4.04c0,2.19,0.7,3.91,2.11,5.16c1.41,1.25,3.21,1.87,5.42,1.87c0.59,0,1.07-0.22,1.45-0.65 c0.38-0.43,0.58-0.96,0.58-1.59c0-0.59-0.19-1.08-0.57-1.47c-0.38-0.38-0.83-0.58-1.35-0.58c-1.52,0-2.28-0.68-2.28-2.05 c0-0.67,0.26-1.26,0.79-1.77c0.52-0.51,1.12-0.76,1.81-0.76c1.01,0,1.89,0.44,2.66,1.3c0.77,0.86,1.15,1.89,1.15,3.09 c0,1.38-0.44,2.66-1.32,3.84c-0.88,1.19-2.05,2.08-3.5,2.68c-1.45,0.6-2.99,0.9-4.61,0.9c-1.6,0-3.08-0.28-4.42-0.85 c-1.34-0.57-2.49-1.36-3.42-2.37c0.94-0.5,1.67-1.05,2.17-1.67s0.76-1.31,0.76-2.09c0-0.88-0.34-1.61-1.03-2.17 s-1.51-0.85-2.48-0.85c-1.26,0-2.34,0.72-3.24,2.16c-0.41-1.31-0.62-2.35-0.62-3.14c0-0.65,0.19-1.27,0.58-1.86 c0.39-0.59,0.93-1.06,1.62-1.42c0.69-0.36,1.56-0.7,2.61-1.02c1.05-0.32,2.26-0.61,3.62-0.86L22.04,5.58z"/>
                  </motion.svg>
                </div>
              ...
              <motion.div
                className="flex flex-col md:flex-row items-end md:items-center md:justify-between mt-10"
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                viewport={{ once: true }}
                transition={{ duration: 0.7, delay: 0.9 }}
              >
                {/* Left side - Doctor image with decorative accent */}
                <motion.div 
                  className="hidden md:flex items-center mb-6 md:mb-0"
                ...
                >
                  <div className="relative">
                    ...
                    <motion.div 
                      className="absolute -bottom-1 -right-1 w-8 h-8 bg-[#5B8C3E] rounded-full flex items-center justify-center shadow-lg text-white"
                  ...
                  <div className="ml-4">
                    <div className="font-semibold text-[#1F2937]">Verified</div>
                    <div className="text-sm text-[#6B7280]">Medical Professional</div>
                  </div>
                </motion.div>
                ...
                <motion.div 
                  className="h-px w-64 bg-gradient-to-l from-[#5B8C3E] via-[#5B8C3E]/60 to-transparent md:hidden"
                  initial={{ width: 0 }}
